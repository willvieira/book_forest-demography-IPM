...
All species except one presented high values of suitable probability at the center and border of their cold and hot ranges.
Among the four conditions, species presented a lower suitable probability at the border of the hot range (red in the right panel).
...
However, at the hot range, we can observe a significant shift in suitable probability from the center to the border.
In addition, we can also observe that the species at the border of the hot range have moved away from the identity line, which means that the effect of heterospecific competition is more significant.
...
Therefore, we can expect competition strength to increase for species distributed at hotter temperatures.
