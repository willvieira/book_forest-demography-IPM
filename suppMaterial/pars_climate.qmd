...
We employ the bioclimatic variables of mean annual temperature (MAT) and mean annual precipitation (MAP), averaging these variables over specific time intervals spanning two measurement periods.
...
The parameters mean and their uncertunity are displayed with the dot interval for growth (green), recruitment (yellow), and survival (brown).
...
#| fig-width: 8.5
#| fig-height: 6
#| fig-cap: "Distribution for the optimal annual mean temperature for growth (green), recruitment (yellow), and survival (brown). The density plot in gray is the distribution of the annual mean temperature among all observed trees across space and time."
...
#| fig-width: 8.5
#| fig-height: 6
#| fig-cap: "Distribution for the optimal mean annual precipitation for growth (green), recruitment (yellow), and survival (brown). The density plot in gray is the distribution of annual precipitation variable among all observed trees across space and time."
...
#| fig-width: 8.5
#| fig-height: 6
#| fig-cap: "Mean annual temperature and mean annual precipitation effect size across the growth (green), recruitment (yellow), and survival (brown) vital rates. The higher the value the stronger is the negative effect of climate when moving from the optimal climate."
...
pars_growth |>
  ...
  theme_classic() +
  xlab('Mean optimal climate relative to species range') +
  ylab(expression( tau^-1)) +
  labs(color = '') +
...
## Marginal effect at the lower and upper climate range
