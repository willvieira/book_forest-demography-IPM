...
In this section, I discuss the climate effect on the growth, survival, and recruitment vital rates.
...
#| fig-width: 8.5
#| fig-height: 7
#| fig-cap: "Distribution for the optimal annual mean temperature ($\\xi_{MAT}$) for growth (green), recruitment (yellow), and survival (brown). The density plot in gray is the distribution of the annual mean temperature among all observed trees across space and time."
