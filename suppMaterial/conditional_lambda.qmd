# Conditional effect of covariates {#sec-margin-lambda}
...
#| fig-width: 8
#| fig-height: 4.5
#| fig-cap: "The Average and 90% confidence intervals values for the population growth rate ($\\lambda$) as a function of normalized mean annual temperature for low (left panel) and high (right panel) competition intensity."
...
#| fig-width: 8
#| fig-height: 4.5
#| fig-cap: "The Average and 90% confidence intervals values for the population growth rate ($\\lambda$) as a function of normalized mean annual precipitation for low (left panel) and high (right panel) competition intensity."
