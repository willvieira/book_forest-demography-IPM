...
For each vital rate and species, the variance among plots was defined by the parameter $\sigma^2_{plot}$ where random effects were generated with $N(0, \sigma^2_{plot})$.
...
To better understand how plots variation affect growth, survival, and recruitment, the following figures show the distribution of the intercept for each vital rate along with the distribution of a randomly generated offset for plots based on their $\sigma^2_{plot}$ parameters.
