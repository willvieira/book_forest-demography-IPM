...
From this pool, we selected the 31 most abundant species as listed in @tbl-tabSpecies.
...
Note that we initially included the *Ostrya virginiana* species in our analysis.
However, we encountered substantial challenges with several parameters in the growth, survival, and recruitment models, which had very large confidence intervals.
As a result, we made the decision to remove this species from our analysis, even though the fit files are still accessible for potential future investigations.
