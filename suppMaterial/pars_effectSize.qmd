...
The idea behind measuring the conditional effect of the covariate at extreme conditions is to assess the maximum effect observed by each species for the specific covariate.
...
Second, we visualize the conditioanl effect size under harsh conditions by selecting the strongest effect size between the maximum and minimum range conditions for each covariate-species combination.
