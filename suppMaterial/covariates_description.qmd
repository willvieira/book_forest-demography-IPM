...
However, all models incorporating the size covariate performed worse compared to the baseline model with plot random effects only (more details in @sec-model_comparison).
