...
In this chapter, we outline the two data sources and the steps taken to organize a create a tidy dataset for our analysis.
We focus in two open inventory data from eastern North America: the Forest Inventory and Analysis (FIA) dataset in the United States [@OConnell2007] and the Forest Inventory of Québec [@Naturelles2016].
...
At the plot level, we retained plots that had been sampled at least twice, excluding those that had undergone harvesting to focus solely on natural dynamics.
...
Post the application of these filters, our final dataset encompassed nearly 26,000 plots, spanning a latitude range from 26° to 53° (@fig-plotCoverage).
