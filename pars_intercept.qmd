...
pars_growth |>
  ...
  theme_classic() +
  xlab('Maximum observed dbh in Burns et al. 1990 (cm)') +
  ylab('Maximum predicted dbh'~Z[infinity]~'(cm)') ->
p
ggsave('../talk_PhDdefence/images/growth_vs_litterature.png', p, width = 6, height = 4)
