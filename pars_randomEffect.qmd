...
However, this section allows us to explore potential spatial correlations by visualizing the spatial distribution of the plot random effects.
To aid visualization, we categorized the continuous offset values into 9 distinct bin classes, as illustrated in the figure below. 
To address the issue of overlapping points within the small figures, we use a transparency gradient that allowed us to assign more emphasis to plots with higher absolute values.
